...
class Config:
    ...
    IMAGE_KEYWORDS = r'\b(image|picture|visual|graphic|photo|illustration)\b'
...
# 3. Use citations [Page X] for text references
# 4. Structure response based on query type:
